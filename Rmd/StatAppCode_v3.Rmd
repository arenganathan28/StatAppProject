...
#
as.data.frame(svydsgn)
#full model:
osteo_model0<- svyglm(osteoporosis ~ age + gender + vitamin_d + vitamind_supp + 
                        calcium_intake + calcium_supp + fractured_wrist, design = restr.age, family = quasibinomial(link= "logit"), data = svydsgn)
summ(osteo_model0,
     exp=TRUE,
     confint=TRUE,
     model.fit = TRUE,
...
pred0 <- predict(osteo_model0,type="response")
pred0
plot
##NOT working yet, just trying some stuff out###
